...
import { IServerSetting, IWorkerCoroutineData } from '@/api/types'
...
export default class extends Vue {
  ...
  private dataRecvTraffic = []
  private dataSendTraffic = []
  private maxY = 0
  private config = {
    type: 'line',
    data: {
  ...
  private async getConnectionInfo() {
    ...
    const { data } = await getConnectionInfo(process, this.$route.query.session_id)
